...
//                      Utils.setDebugMode (true);
            ...
            //set cameraparam
            int max_d = (int)Mathf.Max (rgbMat.rows (), rgbMat.cols ());
            Mat camMatrix = new Mat (3, 3, CvType.CV_64FC1);
            camMatrix.put (0, 0, max_d);
            camMatrix.put (0, 1, 0);
            camMatrix.put (0, 2, rgbMat.cols () / 2.0f);
            camMatrix.put (1, 0, 0);
            camMatrix.put (1, 1, max_d);
            camMatrix.put (1, 2, rgbMat.rows () / 2.0f);
            camMatrix.put (2, 0, 0);
            camMatrix.put (2, 1, 0);
            ...
            //calibration camera
            Size imageSize = new Size (rgbMat.cols () * imageScale, rgbMat.rows () * imageScale);
