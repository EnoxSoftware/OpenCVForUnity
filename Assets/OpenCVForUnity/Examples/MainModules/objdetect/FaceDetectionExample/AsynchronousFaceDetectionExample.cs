...
namespace OpenCVForUnityExample
{
    ...
    public class AsynchronousFaceDetectionExample : MonoBehaviour
    {
        ...
        async void Start()
        {
            ...
            lbp_cascade_filepath = await Utils.getFilePathAsyncTask(LBP_CASCADE_FILENAME, cancellationToken: cts.Token);
            haar_cascade_filepath = await Utils.getFilePathAsyncTask(HAAR_CASCADE_FILENAME, cancellationToken: cts.Token);
