...
namespace OpenCVForUnityExample
{
    ...
    public class ImageClassificationPPResnetExample : MonoBehaviour
    {
        ...
        /// MODEL_FILENAME
        /// </summary>
        protected static readonly string MODEL_FILENAME = "OpenCVForUnity/dnn/image_classification_ppresnet50_2022jan.onnx";
        ...
        async void Start()
        {
            ...
            classes_filepath = await Utils.getFilePathAsyncTask(CLASSES_FILENAME, cancellationToken: cts.Token);
        ...
        void Update()
        {
            if (multiSource2MatHelper.IsPlaying() && multiSource2MatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    Mat prob = net.forward("save_infer_model/scale_0.tmp_0");
